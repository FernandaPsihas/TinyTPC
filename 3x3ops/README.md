...
This program is executed the following way: ./Run-3x3tile.sh base_flag pedestal_flag threshold_flag different_pedestal_files_flag start_run_flag different_config_files_flag copy_to_dune_flag [either "true" or "false"]
...
- copy_to_dune_flag indicates to the program if the local_directory (see below) should be copied to dunegpvm.
