...
do
  ...
  echo "\n------ Attempt: $i_threshold ------"
  echo 'python3 threshold_qc.py --controller_config '${CONFIG_FILENAME}' --disabled_list '${DISABLED_FILE}'  --pedestal_file '${PEDESTAL_FILE}' >> threshold.log  2>&1'
  ...
  python3 threshold_qc.py --controller_config ${CONFIG_FILENAME} --disabled_list ${DISABLED_FILE}  --pedestal_file ${PEDESTAL_FILE} --verbose --cryo>> threshold.log  2>&1
  # --cryo
